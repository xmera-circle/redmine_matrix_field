...
![Redmine Matrix Field Example](https://circle.xmera.de/attachments/download/264/redmine-matrix-field-example.png)
...
git clone -b master https://github.com/xmera-circle/redmine_matrix_field
...
All plugins in the selection are compatible with [Redmine 4](https://redmine.org) and higher.
